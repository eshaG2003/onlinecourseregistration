...
$sem=$_POST['sem'];
$ret=mysqli_query($bd,"insert into courseenrolls(studentRegno,pincode,session,department,level,course,semester,semester_id,level_id,session_id) values('$studentregno','$pincode','$session','$dept','$level','$course','$sem','$semester_id','$level_id','$session_id')");
if($ret)
{
...
<?php } ?>
  ...
  <div class="form-group">
    <label for="level_id">Level before </label>
    <input type="text" class="form-control" id="level_id" name="level_id" <?php echo htmlentities($row['level_id']);?>" required />
  </div> 
  <div class="form-group">
    <label for="semester_id">Semester before </label>
    <input type="text" class="form-control" id="semester_id" name="semester_id" <?php echo htmlentities($row['semester_id']);?>" required />
  </div> 
  <div class="form-group">
    <label for="session_id">Session before  </label>
    <input type="text" class="form-control" id="session_id" name="session_id"<?php echo htmlentities($row['session_id']);?>" required />
  </div> 
