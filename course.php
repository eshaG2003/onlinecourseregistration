...
$ret=mysqli_query($bd, "insert into course(courseCode,courseName,courseUnit,noofSeats,department_id) values('$coursecode','$coursename','$courseunit','$seatlimit','$department_id')");
if($ret)
{
